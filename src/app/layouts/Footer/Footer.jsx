...
export default function Footer() {
  ...
  return (
  <footer className="mt-auto border-t border-t-gray-300 bg-gray-50 text-gray-600">
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row gap-6 md:gap-8 text-sm">
        <div className="flex-1 min-w-[200px]">
          <h3 className="font-semibold text-blue-700 mb-2">LSSCTC</h3>
          <p className="text-gray-500 leading-relaxed">Training & Simulator platform for modern crane operation and logistics safety.</p>
        </div>
        <div>
          <h4 className="font-semibold text-blue-700 mb-2">Explore</h4>
          <ul className="space-y-1">
            ...
            <li><a href="/simulator" className="hover:text-blue-600">Simulator</a></li>
            <li><a href="/assessments" className="hover:text-blue-600">Assessments</a></li>
          </ul>
        </div>
        <div>
        ...
        <div>
          <h4 className="font-semibold text-blue-700 mb-2">Contact</h4>
      ...
      <div className="bg-gray-50/70 backdrop-blur">
        <div className="max-w-7xl mx-auto px-4 pt-2 pb-4">
          ...
          <div className="text-xs text-gray-500 flex flex-col md:flex-row gap-3 md:gap-6 items-center justify-between">
