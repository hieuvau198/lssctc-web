import { Video, Trash2, Pencil, Play } from 'lucide-react';
import { Tooltip, App, Table, Pagination } from 'antd';
    ...
    return (
      <div className="py-12 flex flex-col items-center justify-center">
        ...
        <p className="text-neutral-500 font-bold uppercase tracking-wider text-sm">
          {t('instructor.materials.noVideos')}
        </p>
      </div>
    );
  }
    ...
    },
    {
      ...
      render: (text) => (
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-black border border-black flex items-center justify-center flex-shrink-0">
        ...
        <div className="flex gap-2 justify-center">
          <Tooltip title={t('instructor.materials.tooltip.openVideo')}>
            <button
              ...
              className="w-9 h-9 bg-black border-2 border-black flex items-center justify-center hover:scale-105 transition-transform"
            >
        ...
        <Pagination
          ...
          showTotal={(total, range) => (
            <span className="text-sm font-medium text-neutral-600">
              {range[0]}-{range[1]} / {total} {t('instructor.materials.videos').toLowerCase()}
            </span>
          )}
        />
      </div>
