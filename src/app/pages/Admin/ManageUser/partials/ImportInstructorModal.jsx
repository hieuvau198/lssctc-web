...
import { downloadInstructorTemplate, importInstructorFromExcel } from '../../../../apis/Admin/AdminUser';

const { Text } = Typography;

const ImportInstructorModal = ({ visible, onCancel, onSuccess }) => {
    ...
    const handleDownloadTemplate = async () => {
        setDownloading(true);
        try {
            await downloadInstructorTemplate();
    ...
    const handleImport = async () => {
        ...
        try {
            const result = await importInstructorFromExcel(file);
            ...
            if (msg.includes('Skipped') || msg.includes('Errors') || msg.includes('Imported 0')) {
                ...
                message.success(msg || 'Import giảng viên thành công!');
                setFileList([]);
                onSuccess();
            }
        } catch (error) {
                ...
                <div className="text-sm text-gray-600 space-y-4">
                    <div>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            ...
                            <li>Điền thông tin giảng viên vào các cột tương ứng.</li>
        ...
        <Modal
            ...
            title={
                <div className="flex items-center gap-2">
                    ...
                    <span>Import Giảng viên từ Excel</span>
                </div>
            }
            onCancel={onCancel}
            footer={[
