...
import { Card, Badge, Empty, Select, Tabs } from 'antd';
      ...
      <div className="mb-4 flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold">{t('attendance.myWeeklySchedule')}</h3>
          </div>
          <Select
            value={selectedClass}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex border border-slate-300 rounded overflow-hidden">
            <button
              ...
              className="px-2 py-1.5 hover:bg-slate-50 border-r border-slate-300"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-7 gap-3">
        {weekDays.map((date, index) => {
          ...
          return (
            ...
            >
              <div className="mb-2">
                <div className={`text-xs font-medium uppercase ${today ? 'text-blue-600' : 'text-slate-500'}`}>
                ...
                {today && (
                  <div className="text-xs text-blue-600 font-medium">{t('attendance.today')}</div>
                )}
              </div>
