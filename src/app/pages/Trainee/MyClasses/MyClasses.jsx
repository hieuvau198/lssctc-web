        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <h1
                className="text-4xl lg:text-5xl font-black uppercase tracking-tight mb-4 text-white drop-shadow-xl"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {loading && (
            <div className="min-h-[400px] flex flex-col items-center justify-center">
              ...
              <p className="text-neutral-500 uppercase tracking-wider font-semibold">
                {t("common.loading")}
              </p>
            </div>
          )}
          ...
          {!loading && programs.length === 0 && (
            <div className="min-h-[400px] flex flex-col items-center justify-center">
              ...
              <p className="text-neutral-900 text-lg font-black uppercase">
                {t("trainee.myLearning.noClasses")}
              </p>
              <p className="text-neutral-500 text-sm mt-2">
                Hãy đăng ký một khóa học để bắt đầu
              </p>
            </div>
          )}
                ...
                >
                  <div className="bg-white border-2 border-neutral-900 hover:border-yellow-400 overflow-hidden transition-all duration-300">
                    ...
                    <div
                      className={`h-2 ${
                        p._statusMapped &&
                        getClassStatus(p._statusMapped).color === "green"
                          ? "bg-yellow-400"
                          : "bg-neutral-200"
                      }`}
                    />
                    ...
                    <div className="p-5">
                        ...
                        {p._statusMapped &&
                          (() => {
                            ...
                            const translatedLabel = t(
                              `common.classStatus.${s.key}`,
                              { defaultValue: s.label }
                            );
                            return (
                              <span
                                className={`px-2 py-0.5 text-xs font-bold uppercase tracking-wider flex-shrink-0 ${
                                  s.color === "green"
                      ...
                      <div className="space-y-2.5">
                        <div className="flex items-center gap-3 text-sm">
                          ...
                          <div>
                            <div className="text-neutral-500 text-xs uppercase font-bold">
                              {t("trainee.startDate")}
                            </div>
                        ...
                        <div className="flex items-center gap-3 text-sm">
                          ...
                          <div>
                            ...
                            <div className="text-neutral-900 font-semibold">
                              {p.durationHours} {t("common.hours")}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-end gap-1.5 text-sm font-bold text-yellow-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-4 uppercase tracking-wider">
                        <span>
                          {t("trainee.viewDetails") || "Xem chi tiết"}
                        </span>
