...
export default function CertificateView() {
	...
	return (
		<div className="max-w-[980px] mx-auto px-4 py-6">
			...
			<div className="flex items-center justify-between bg-white border rounded-xl p-4 mb-4 print:hidden">
				...
				<div className="border-2 border-slate-200 rounded-2xl p-10 bg-white relative overflow-hidden">
					...
					<div className="relative">
						<div className="flex items-center justify-center gap-3 mb-2">
							...
							<h2 className="text-3xl font-bold text-slate-800">Certificate of Completion</h2>
						</div>
						<p className="text-center text-slate-600 mb-6">This is to certify that</p>

						<div className="text-center">
							<div className="text-3xl font-semibold text-slate-900">{cert.learnerName}</div>
							<p className="text-slate-600 mt-2">has successfully completed</p>
							<div className="text-2xl font-medium text-blue-700">{cert.course}</div>
